...
namespace Drupal\finders_facets\Plugin\facets\query_type;
 ...
 *
 * @see https://github.com/localgovdrupal/localgov_directories/issues/193
 *
 * @FacetsQueryType(
 *   id = "finders_facets_query_type",
 *   label = @Translation("Finders Facet Groups AND Query Type"),
 * )
 */
class FindersFacetsQueryType extends QueryTypePluginBase {
